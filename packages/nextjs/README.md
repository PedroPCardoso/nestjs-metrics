...
[`@pedropcardoso/metrics-core`](../core)'s ORM-agnostic executor — the same fluent API as
the TypeORM path.

```bash
npm i @pedropcardoso/metrics-nextjs
```
...
See [`@pedropcardoso/metrics-core`](../core) for the complete fluent API.
